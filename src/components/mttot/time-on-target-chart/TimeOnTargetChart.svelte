<script lang="ts">
    ...
    import { sdpsExtraDelay, selectedDistributor, selectedWeapons } from '../store';
...
<style lang="scss">
    ...
    .create-a-chart-container { // This is fixed as to always have the output image not have large amounts of "whitespace"
